...
class Board:
    ...
    def move(self, dir):
        ...
        if (not self.tryDir(dir)):
            ...
            if (dir == 'l' or dir == "left"):
                for row in range(0,4):
                    newboard.board[row] = makeMove(newboard.board[row])
            elif (dir == 'u' or dir == "up"):
                for col in range(0, 4):
                    vector = []
                    for row in range(0, 4):
                        vector.append(newboard.board[row][col])
                    vector = makeMove(vector)
                    for row in range(0, 4):
                        newboard.board[row][col] = vector[row]
            elif (dir == 'r' or dir == "right"):
                for row in range(0,4):
                    vector = []
                    for col in range(0, 4):
                    ...
                    vector = makeMove(vector)
                    for col in range(0, 4):
                        newboard.board[row][3-col] = vector[col]
            elif (dir == 'd' or dir == "down"):
                for col in range(0, 4):
                    vector = []
                    for row in range(0, 4):
                    ...
                    vector = makeMove(vector)
                    for row in range(0, 4):
                        newboard.board[3-row][col] = vector[row]
            return newboard
